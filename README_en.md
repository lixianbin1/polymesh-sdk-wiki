...
Polymesh is a technology that enables you to create, issue and manage digital securities on the blockchain. It aims to link the regulation and compliance of traditional securities with blockchain technology, and is an institutional licensed blockchain built specifically for regulated assets. Polymesh's technology and infrastructure have great potential in improving the efficiency of traditional investment banking processes. The Polymesh SDK is just an encapsulated development library that is more conducive to development.

This is a document library, which is designed to provide a learning reference for the follow-up learners
...
Get the account instance through the address
